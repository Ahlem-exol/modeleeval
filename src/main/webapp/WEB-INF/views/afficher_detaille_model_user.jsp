        ...
        <div class="container-fluid">
          <div class="card">
            ...
            <div class="card-header card-header-primary">
              ...
              <p class="card-category">Description de modèle :<a href="http://bootstrap-notify.remabledesigns.com/" target="_blank">${model.explain }</a>
              </p>
            </div>
...
<b>Réference bibliographique</b>:${article.refernceArticle}
    ...
    <div class="col-md-6">
                  ...
                  <c:forEach items="${auteurs}" var="result"> 
							...
							<span>-${ result.nom} ${result.prenom} ${result.univers}</span>	
 ...
 <!-- ###########################################download  ##############################" -->
  ...
  <div class="modal-dialog">
    ...
    <select class="valid" class="form-control" id="type"  name="type">
    <option value="0"  class="form-control" > txt </option>
    <option value="1"  class="form-control"  >xlsx(excel)</option>
    <option value="2"  class="form-control" >docx (word)</option>    
  </select>
    </div>
</div>
